import { Map, Warehouse, Calculator, Shield, FlaskConical, Hammer, BookOpen, Scale, Wheat, Users } from "lucide-react";
import { useGameStore } from "../store/gameStore";

// 右侧竖排功能钮：州县/民生/仓廪/会计/军政/科技/国策/工程/典籍/群臣
// （迁移补齐：Tk 右侧栏含「民生」「群臣」两项，Web 原缺——民生开 POP 面板、群臣开大臣面板）
const ITEMS: { key: string; label: string; icon: React.ReactNode }[] = [
  { key: "prefecture", label: "州县", icon: <Map size={20} /> },
  { key: "pop", label: "民生", icon: <Wheat size={20} /> },
