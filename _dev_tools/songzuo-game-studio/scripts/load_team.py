...
def guess_owners(task, members):
    ...
    kw = {
        "event": ["event-narrative-designer", "song-narrative-designer", "ai-prompt-designer"],
        "叙事": ["event-narrative-designer", "song-narrative-designer", "ai-prompt-designer"],
        "史实": ["song-narrative-designer"],
        "事件卡": ["event-narrative-designer"],
        "诏书": ["event-narrative-designer", "ai-prompt-designer"],
        "数值": ["strategy-systems", "economy-systems", "data-analytics"],
        "平衡": ["strategy-systems", "data-analytics"],
        "派系": ["strategy-systems"],
        "结局": ["settlement-engineering", "strategy-systems"],
        "结算": ["settlement-engineering", "economy-systems"],
        "财政": ["economy-systems"],
        "经济": ["economy-systems"],
        "仓廪": ["economy-systems"],
        "物价": ["economy-systems"],
        ...
        "状态": ["core-engineering"],
        "迁移": ["core-engineering"],
        "prompt": ["ai-prompt-designer", "ai-pipeline"],
        "模板": ["ai-prompt-designer"],
        "ai": ["ai-pipeline", "ai-prompt-designer", "ai-integration"],
        "连通": ["ai-integration"],
        "界面": ["tkinter-ui", "ui-panels"],
        "ui": ["tkinter-ui", "ui-panels"],
        "面板": ["ui-panels"],
        "主题": ["tkinter-ui"],
        "舆图": ["tkinter-ui"],
        "美术": ["art-assets"],
        ...
        "测试": ["regression-qa", "gui-release-qa"],
        "回归": ["regression-qa", "gui-release-qa"],
        "gui": ["gui-release-qa"],
        "打包": ["release-engineering", "gui-release-qa"],
        "exe": ["release-engineering", "gui-release-qa"],
        "发布": ["release-engineering", "gui-release-qa"],
        "遥测": ["data-analytics"],
        "模拟": ["data-analytics"],
    }
    hits = []
