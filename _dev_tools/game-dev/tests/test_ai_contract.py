...
def test_effect_whitelist_17_keys():
    """白名单与 _TIER_BASE 对齐（审查 P1-2 修复后含 art_mastery，共 18 维度）。"""
    assert len(_EFFECT_WHITELIST) == 18
    for k in ("prestige", "treasury", "land_survey", "hoard", "commerce_tax", "reform", "art_mastery"):
