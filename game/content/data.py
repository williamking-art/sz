...
EXTERNAL_ECON = {
    ...
    "GOODS_EXT_PRICES": {"布": 1.5, "绸": 6.0, "酒": 2.0, "茶": 3.0,
                          ...
                          "果干": 2.0, "蔗糖": 1.5},
    # 省域建筑（4 类，×0.05/Lv，Lv1–5；自动演化，无玩家诏令通道）
    "BUILDING_TYPES_EXT": ("农田", "牧场", "工坊", "商铺"),
...
# 外邦省份默认建筑（审查 2026-09）：无独立建筑系统，按政权 type 给可展示的简单建筑
# （显示用 + 供未来占领/经营扩展）。取值 {建筑名: 座数}。
def external_province_buildings(pop_type: str) -> dict[str, int]:
