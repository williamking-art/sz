...
CIRCUIT_INFO: dict = {
    ...
    "夔州路": {"type": "沿边", "seat": "夔州", "game_unit": None,
               "members": [("夔州", "州", 109.46, 31.02), ("忠州", "州", 108.04, 30.30),
                            ...
                            ("施州", "州", 109.49, 30.27)]},
    "京东东路": {
        "type": "腹里", "seat": "青州", "game_unit": None,
        "members": [
            ("青州", "府", 118.48, 36.68),
            ("密州", "州", 119.41, 35.99),
            ("沂州", "州", 118.35, 35.06),
    ...
    "京东西路": {
        "type": "腹里", "seat": "兖州", "game_unit": None,
        "members": [
            ("兖州", "州", 116.83, 35.55),
            ("徐州", "州", 117.18, 34.26),
            ("济州", "州", 116.06, 35.40),
...
REGIME_PARTS: dict = {
    ...
    "辽": {
        "sub_roads": {
            "南京道": {
                "seat": "析津府", "seat_at": [116.4, 39.9], "label_at": [117.6, 39.8],
                "prefectures": {
                    "北京市": "*", "天津市": "*",
                    "河北省": ["唐山市", "秦皇岛市"],
                },
            ...
            "西京道": {
                "seat": "大同府", "seat_at": [113.3, 40.1], "label_at": [112.7, 41.1],
                "prefectures": {
                    "山西省": ["大同市", "朔州市"],
                    "河北省": ["张家口市"],
            ...
            "中京道": {
                "seat": "大定府", "seat_at": [120.2, 41.6], "label_at": [117.0, 43.5],
                "prefectures": {
                    "河北省": ["承德市"],
                    "内蒙古自治区": ["赤峰市", "锡林郭勒盟"],
                    "辽宁省": ["朝阳市", "阜新市"],
            ...
            "东京道": {
                "seat": "辽阳府", "seat_at": [123.2, 41.3], "label_at": [125.1, 41.8],
                "prefectures": {
            ...
            "上京道": {
                "seat": "临潢府", "seat_at": [119.4, 43.9], "label_at": [124.9, 47.6],
                "prefectures": {
                    "黑龙江省": "*",
    ...
    "西夏": {
        "sub_roads": {
            "兴庆府直辖": {
                "seat": "兴庆府", "seat_at": [106.3, 38.5], "label_at": [103.1, 39.9],
                "prefectures": {
                    "宁夏回族自治区": "*",
                    "内蒙古自治区": ["乌海市", "阿拉善盟"],
                },
            ...
            "河西走廊": {
                "seat": "西凉府", "seat_at": [102.6, 37.9], "label_at": [99.8, 40.1],
                "prefectures": {
            ...
            "河南地": {
                "seat": "西平府", "seat_at": [106.3, 38.1], "label_at": [106.7, 36.9],
                "prefectures": {
