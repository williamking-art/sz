...
CIRCUIT_INFO: dict = {
    "京畿路": {
        "type": "京畿", "seat": "开封府", "game_unit": "东京开封府",
        "members": [
            ("开封府", "京府", 114.31, 34.80),
            ("颍昌府", "府", 113.85, 34.04),
            ("郑州", "州", 113.63, 34.75),
...
REGIME_GEO: dict = {
    ...
    "金": {"name": "金", "active": False, "owner": "金", "label_at": [128.5, 44.5],
    ...
    "琉球": {"name": "琉球", "active": True, "owner": "琉球", "label_at": [127.5, 27.0],
             "polygon": [[126.8, 26.6], [127.6, 26.2], [128.3, 26.8], [128.2, 27.8],
                          [127.0, 27.5], [126.8, 26.6]]},
}
...
REGIME_PARTS: dict = {
    ...
    "西夏": {
        ...
        "prefectures": {
            "宁夏回族自治区": "*",
            "甘肃省": ["金昌市", "白银市", "武威市", "张掖市", "酒泉市", "嘉峪关市",
                       "兰州市", "定西市", "平凉市", "庆阳市", "陇南市", "天水市", "临夏回族自治州"],
            "内蒙古自治区": ["乌海市", "巴彦淖尔市", "鄂尔多斯市", "阿拉善盟"],
        },
    },
    "吐蕃": {
        "provinces": ["青海省", "西藏自治区"],
    ...
    "高丽": {
        "union_external": {"file": "ne_admin1_kr_jp.json",
