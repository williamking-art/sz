  ...
  return (
    <div className="flex flex-col items-center space-y-6 py-2">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        />
        <div className="relative mt-1 mb-1 flex h-16 w-16 items-center justify-center rounded-full bg-red shadow-card ring-4 ring-gold">
          <span className="font-kai text-3xl font-bold tracking-widest text-[#f8ecd0]">宋</span>
          <img
            src="/images/seal_imperial.png"
            alt=""
            className="absolute -bottom-1 -right-1 h-7 w-7 rounded-full object-cover ring-1 ring-gold-dark"
          />
        </div>
      ...
      {view === "menu" ? (
        ...
        <div className="w-full max-w-sm space-y-2.5">
          ...
          <button
            ...
            className="group sz-card flex w-full items-center justify-between border-2 border-gold/60 px-5 py-3 transition hover:border-red"
          >
