...
| 设计 | 文档 | 一句话 |
|---|---|---|
| 货币口径 | [货币口径规范_M0M1M2.md](../_dev_tools/game-docs/docs/货币口径规范_M0M1M2.md) | 引入 M0/M1/M2/M3 与月度对账恒等式，使"凭空造币/销毁"在构造上可观测；含仓鼠症与国库封桩分层 |
| 财力消耗 | [财力消耗设计.md](../_dev_tools/game-docs/docs/财力消耗设计.md) | 六层 money sink；核心为 **L1 资产维持费**（随资产存量增长）与 **L2a 军俸补足至史实** |
| 官制与三冗 | [宋代官制与三冗设计.md](../_dev_tools/game-docs/docs/宋代官制与三冗设计.md) | 官/职/差遣分离、冗官量化定义、政务量 W 界定、地方三层可见性与路级四司、科举离散科次、吏员制度、公务员化 |
