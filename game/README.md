...
进度：**① ✅ 已完成**（P0×9 ＋ 测试整理）｜**② ✅ 已收口**（B-1 观测 → B-2 守恒 → B-2′ 军俸/欠饷 → B-3 L1 维持费）｜**③ 🔶 主体已完成**（C-1～C-7：官额随 POP 增长、身份子池、铨选双阀、致仕/磨勘/恩荫/宗室、宗室俸禄、免役税基、吏制四机制、科举离散科次、9 项编制参数可政令调整；余 C-8 地方三层可见性与 C-5′ 吏制奏议外显）。详见 [fix_plan_2026-09-18.md](../_dev_tools/game-docs/analysis/fix_plan_2026-09-18.md)。
